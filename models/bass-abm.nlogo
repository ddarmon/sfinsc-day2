...
<experiments>
  <experiment name="Mean Degree Experiment" repetitions="10" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="mean-degree" first="2" step="1" last="10"/>
    ...
    <enumeratedValueSet variable="num-seed-adopters">
      <value value="10"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Social Influence Experiment" repetitions="10" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="mean-degree">
      <value value="20"/>
    </enumeratedValueSet>

...
turtles-own [ adopted? threshold seed?]
...
to setup
  ...
  if network-type = "erdos-renyi"[
    let edge-prob (2 * mean-degree)/(num-agents - 1)
  ...
  if network-type = "watts-strogatz"[
    nw:generate-watts-strogatz turtles links num-agents mean-degree 0.1
  ]

  if network-type = "facebook"[
    load-network "facebook_combined.nlgraph"
  ]
  ...
  set previous-count (count turtles with [adopted?])
...
to setup-nodes
  ask turtles[
    ...
    let u random-float max-influence-threshold

    set threshold (max-influence-threshold - min-influence-threshold) * u + min-influence-threshold
  ]
end
...
to go
  ...
  if (previous-count = count turtles with [adopted?]) and (broadcast-influence = 0)[
    stop
  ]
  set previous-count (count turtles with [adopted?])
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;    Method to resample the threshold of each node from a uniform
;;;    distribution on [min-influence-threshold, max-influence-threshold].
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;    Method to reset the nodes to unadopted state.
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;    Method to reseed the adopted nodes and reset remaining nodes.
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;    Method to cause an unadopted agent to adopt, based on either broadcast-influence
;;;    or their threshold/neighbor interaction.
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to adopt
  ...
  if not adopted? and (count neighbors-adopted / count total-neighbors) > threshold [
    set adopted? true
    set color yellow
  ]
  ]
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;
;;;    Methods to load in the Facebook network from facebook_combined.nlgraph.
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to load-network [ fname ]
  file-open fname
  set num-agents read-from-string file-get-next-noncomment-line
...
network-type
network-type
"preferential-attachment" "erdos-renyi" "watts-strogatz" "facebook"
1
